...
function canvasApp() {
	...
	//var btnExport = document.getElementById("body");
	btnExport.addEventListener("load", exportPressed, false);
	
	var btnRegenerate = document.getElementById("btnRegenerate");
	//var btnRegenerate = document.getElementById("body");
	btnRegenerate.addEventListener("load", regeneratePressed, false);
